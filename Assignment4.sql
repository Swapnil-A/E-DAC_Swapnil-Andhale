...
Select employee.emp_name ,employee.salary ,employee1.dept_name ,employee1.dept_id from employee
INNER join employee1 on employee.empid = employee1.empid ;

Select employee.dept_name ,employee.emp_name,employee1.dept_name ,employee1.dept_id from employee 
LEFT JOIN employee1 ON employee.dept_id = employee1.dept_id ;

Select employee.dept_name ,employee.emp_name,employee1.dept_name ,employee1.dept_id  from employee 
right JOIN employee1 ON employee.dept_id = employee1.dept_id ;

select distinct E.empid FROM employee1 E INNER JOIN employee1 M ON E.empid = M.dept_id ;
