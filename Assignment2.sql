...
select *from authors where aname  regexp '[[er:>:]]';
...
insert into Emp values(1652.7);
insert into Emp values(1775.152);

select * from emp ;
delete from emp where sal = 1775.151;
...
SELECT DATE_ADD('1998-01-02', INTERVAL 365 DAY);
